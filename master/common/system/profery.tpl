			...
			<table class="task" width="100%">	
				<tr>
					...
					<td class="td2">
                        ...
                        <input type="text" name="lookup.title" class="required short" value="<?php echo $fd->title?>" lookupGroup="lookup" disabled="disabled" readonly="readonly"/>
						 <a class="btnLook" lang="m=system&c=dict&ids=collage" width="680" height="560" lookupGroup="lookup" title="选择院校">选择院校</a>
						<ins>(必选，专业所属院校。)</ins>
					</td>
				</tr>
				<tr>                        
