<div class="pageContent">
	<form method="post" action="handle.php?m=attach&c=add&a=flink" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone)" id="upform" enctype="multipart/form-data">
		<div class="pageFormContent" layoutH="51">
			<table class="task" width="100%">	
				<tr>					
					<td class="td1">链接类型：</td>
					<td class="td2">
						<input type="radio" class="cbx" name="fid" value="0" checked="true"/>友情链接
						<input type="radio" class="cbx" name="fid" value="1"/>合作伙伴
