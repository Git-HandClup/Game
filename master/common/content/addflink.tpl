<div class="pageContent">
	<form method="post" action="handle.php?m=flink&c=add" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone)" id="upform" enctype="multipart/form-data">
