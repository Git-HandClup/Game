<?php 
$data = $tpl->GetSingleInfo('activity','id='.$ids);
extract($data);
?>
<div class="pageContent">
<form method="post" action="handle.php?m=activity&c=edit&ids=<?php echo $ids;?>" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone)" id="upform" enctype="multipart/form-data">
	<div class="pageFormContent" layoutH="50">				
		<table class="task" width="100%" style="margin-bottom:6px"> 
			...
			<tr>
				...
				<td class="td2">
					<input name="qrcode" id="qrcode" type="text" class="normal" value="<?php echo $qrcode;?>"/>
					<div class="buttonActive">
						<div class="buttonContent">
							<a class="upload" title="上传文件">本地上传...</a>
			...
			<tr>
				...
				<td class="td2">
					<input type="text" name="sdatetimes" class="required short date" value="<?php echo date('Y-m-d',$sdatetimes);?>" readonly="readonly"/>
			...
			<tr>
				...
				<td class="td2">
					<input type="text" name="edatetimes" class="required short date" value="<?php echo date('Y-m-d',$edatetimes);?>" readonly="readonly"/>
			...
			<tr>
				<td class="td2" colspan="2">
					...
					<textarea name="content" tool="full" class="editor require" style="width:100%;height:430px;"><?php echo $content;?></textarea>
				</td>
			</tr>
		</table>			
	</div>
