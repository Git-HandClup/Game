<?php
$data = $tpl->GetSingleInfo($pos,'id='.$ids);
extract($data);
?>
<div class="tabs" style="border-bottom:1px solid #aec3de;background:#fff">
	...
	<form method="post" action="handle.php?m=<?php echo $pos?>&c=edit&ids=<?php echo $ids?>" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone)" id="upform" enctype="multipart/form-data">
	...
	<div class="pageFormContent" style="border-top:0">				
		<table class="task" width="100%"> 
			...
			<tr>
				...
				<td class="td2">
					<select name="fid" class="required combox" curval="<?php echo $fid?>">
			...
			<tr>
				...
				<td class="td2">
					<input type="text" name="pid" class="required digits short" value="<?php echo $pid?>" />
			...
			<tr>
				...
				<td class="td2">
					<input type="text" name="price" class="required digits short" value="<?php echo $price?>" />
			...
			<tr>
				...
				<td class="td2">
					<input type="text" name="volume" class="required digits short" value="<?php echo $volume?>" />
			...
			<tr>
				...
				<td class="td2">
					<input type="text" name="percent" class="required digits short" value="<?php echo $percent?>" />
			...
			<tr>
				...
				<td class="td2">
					<input type="text" name="money" class="required digits short" value="<?php echo $money?>" />
			...
			<tr>
				...
				<td class="td2">
					<input type="text" name="infourl" class="long" value="<?php echo $infourl?>" />
			...
			<tr>
				...
				<td class="td2">
					...
					<textarea  name="piclist" id="piclist" style="height:60px;line-height:18px;margin-top:4px" readonly="readonly"><?php echo $piclist?></textarea>
				</td>
			</tr>
			<tr>
		...
		<div class="pageFormContent" style="border-top:0">
			<table class="task" width="100%">
				<tr>
					...
					<td class="td2">
						<select name="platform" class="required combox" curval="<?php echo $platform?>">
				...
				<tr>
					...
					<td class="td2">
						<input type="text" name="coupon" class="required normal" value="<?php echo $coupon?>" />
				...
				<tr>
					...
					<td class="td2">
						<input type="text" name="maxtotal" class="required digits short" value="<?php echo $maxtotal?>" />
				...
				<tr>
					...
					<td class="td2">
						<input type="text" name="mintotal" class="required digits short" value="<?php echo $mintotal?>" />
				...
				<tr>
					...
					<td class="td2">
						<input type="text" name="discount" class="required normal" value="<?php echo $discount?>" />
				...
				<tr>
					...
					<td class="td2">
						<input type="text" name="sdatetimes" class="required date short" value="<?php echo date('Y-m-d',$sdatetimes)?>" />
						<ins>(优惠券有效期起始时间.)</ins>
					</td>
				</tr>
				<tr>
					...
					<td class="td2">
						<input type="text" name="edatetimes" class="required date short" value="<?php echo date('Y-m-d',$edatetimes)?>" />
						<ins>(优惠券有效期结束时间.)</ins>
					</td>
				</tr>
				...
				<tr>
					...
					<td class="td2">
						<input type="text" name="seller" class="normal" value="<?php echo $seller?>" />
						<ins>(商品来源的店铺ID)</ins>
					</td>
				</tr>
				<tr>
					...
					<td class="td2">
						<input type="text" name="store" class="normal" value="<?php echo $store?>" />
						<ins>(商品来源的店铺名称)</ins>
					</td>
				</tr>
				<tr>
					...
					<td class="td2">
						<input type="text" name="contact" class="normal" value="<?php echo $contact?>" />
				...
				<tr>
					...
					<td class="td2">
						<input type="text" name="acturl" class="long" value="<?php echo $acturl?>" />
						<ins>(优惠券领取地址)</ins>
					</td>
				</tr>
				<tr>
					...
					<td class="td2">
						<input type="text" name="actpath" class="long" value="<?php echo $actpath?>" />
						<ins>(优惠券领取地址)</ins>
					</td>
				</tr>
				<tr>
					...
					<td class="td2">
						<input type="text" name="taokeurl" class="long" value="<?php echo $taokeurl?>" />
						<ins>(商品推广地址)</ins>
					</td>
				</tr>
			</table>
			...
			<table class="task" width="100%">		                                              
				...
				<tr>
					<td class="td2" colspan="2">
						...
						<textarea name="content" tool="full" class="editor require" style="width:100%;height:544px;"><?php echo $content?></textarea>
					</td>
				</tr>
			</table>
		</div>
