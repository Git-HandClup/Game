<div class="pageContent">
	<form method="post" action="handle.php?m=hotkey&c=add" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone)" id="upform" enctype="multipart/form-data">
		<div class="pageFormContent" layoutH="51">
			<table class="task" width="100%">				
				...
				<tr>
					...
					<td class="td2">
						<select class="combox" onchange="tps.setskin(1,this,'font-family',this.value)">
				...
				<tr>
					...
					<td class="td2">
						<select class="combox" onchange="tps.setskin(2,this,'font-size',this.value)">
				...
				<tr>
					...
					<td class="td2">
					<input type="checkbox" style="width:40px" onclick="tps.setskin(3,this,'font-weight','700')"/>
					</td>
				</tr>				
				<tr>
					<td class="td1">排序号：</td>
					<td class="td2">
						<input type="hidsden" name="style" id="style" value=""/>
